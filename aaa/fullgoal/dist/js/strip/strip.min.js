...
! function (a) {
    ...
    var Pages = {
            ...
            show: function (a, b) {
                ...
                return this.page && this.page.uid == c.uid ? void(c.view.options.toggle && (Window.hide(), this.page = null)) : (this.page = c, this.removeHiddenAndLoadingInactive(), void c.show($.proxy(function () {
