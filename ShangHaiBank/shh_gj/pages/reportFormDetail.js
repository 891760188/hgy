...
//			})(mui, document);
		...
		myChart2.setOption(option2);
			...
			window.addEventListener('resize',function(){
				$("#tableContent").html('<table id="jqGrid"></table>');
				var _width=document.body.scrollWidth;
				var _height=document.body.scrollHeight;
				if(_width>_height){
//					橫屏
					document.getElementById('mychartForm').style.width="0px";
					document.getElementById('mychartForm').style.height="0px";
				}else{
					document.getElementById('mychartForm').style.height="263px";
					document.getElementById('mychartForm').style.width=_width+"px";
					
				}
				initReport();
//				var _width=document.body.scrollWidth;
//				var x = document.getElementById('myReportChart1').style.width=_width+"px";
				chart1();
		});
		//恢复默认
