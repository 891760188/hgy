...
//应用配置文件
document.write('<script src="' + _filePath + _AppName +'/common/AppConfig.js"></script>');
...
//document.write('<link rel="stylesheet" type="text/css" href="' + _filePath + 'resource/mui/css/mui.indexedlist.css"/>');
...
document.write('<script src="' + _filePath + _AppName +'/common/ui.js"></script>');
