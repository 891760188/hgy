...
var appConfig = {
	...
	//分页配置 
	pageInfoConfig: {
		url: basePath + 'mobilePriceFtpAction!getData.json', //查询URL
		pageSize: 6,							 //分页大小
		...
		success: function(response){
			...
			for(var i=0;i<data.length;i++){
				...
				divs.innerHTML='<div class="radlcTitle">'+data[i].title+'</div>'
							+'<div class="radlcRow">产品名称：<span>'+data[i].productname+'</span></div>'
							+'<div class="radlcRow">FTP价格：<span>'+data[i].price+'</span></div>';
